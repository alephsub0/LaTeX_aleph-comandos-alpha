...
\begin{abstract}
    \file{aleph-comandos.sty} es un paquete creado para recopilar varios comandos de uso común entre los colegas de Andrés Merino, dentro de su proyecto personal Alephsub0 (\url{https://www.alephsub0.org/}).
\end{abstract}
...
A continuación se detallan las abreviaciones que sirven únicamente en modo matemático.
    \begin{center}
        ...
        \hline
            ...
            |\texty| & $.\texty.$ & Texto ``y'' con espacio doble \\
            |\yds| & $.\yds.$ & Texto ``y'' con espacio \\
            |\texto| & $.\texto.$ & Texto ``o'' con espacio doble\\
...
\begin{center}
    ...
    \hline
        ...
        |\imp| & $\imp$ & Implicación \\
        |\Imp| & $\Imp$ & Implicación \\
        |\qDimp| & $.\qDimp.$ & Doble implicación \\
        |\qImp| & $.\qImp.$ & Implicación \\
        |\qland| & $.\qland.$ & Conjunción con espacio\\
        |\andm| & $.\andm.$ & Conjunción con espacio \\
        |\qlor| & $.\qlor.$ & Disyunción con espacio \\
        |\orm| & $.\orm.$ & Disyunción con espacio \\
        |\V| & $\V$ & Tautología \\
        |\F| & $\F$ & Contradicción\\
    \hline
    \end{tabular}
...
\begin{center}
    ...
    \end{tabular}
\end{center}
Estos comandos no se pueden utilizar a la par con el paquete \package{mmacells}.
